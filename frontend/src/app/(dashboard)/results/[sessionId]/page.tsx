...
import { Session, Skill, Question, CoachFeedback, WritingFeedback, SpeakingFeedback } from '@/types';
          ...
          <div className="p-4">
            {session.responses[activeTab] && (
              <FeedbackPanel
                ...
                feedback={session.responses[activeTab].feedback as WritingFeedback | SpeakingFeedback}
